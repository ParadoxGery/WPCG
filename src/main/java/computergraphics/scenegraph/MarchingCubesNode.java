...
public class MarchingCubesNode extends Node {
	...
	public MarchingCubesNode(int resolution,double minRange, double maxRange, HalfEdgeTriangleMesh mesh, ImplicitFunktions function) {
		cubes = new ArrayList<>();
		this.mesh = mesh;
		...
		this.mesh.doMarchingCube(cubes);
