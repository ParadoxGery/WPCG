...
public class HalfEdgeTriangleMesh implements ITriangleMesh {
	...
	private void createTriangles(List<Vector3> points, List<Double> values, double tau) {
		int caseIndex = 0;
		...
		int[] edges = Arrays.copyOfRange(CaseDictionary.faces, caseIndex * 15, (caseIndex + 1) * 15);
	...
	public void doMarchingCube(List<MarchingCube> cubes, ImplicitFunktions funktion) {
